...
> **[v1.21.11](https://github.com/ram-prices/AfterSync/releases/tag/v1.21.11)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;23 patches total
<details open>
...
| [Fix inline comment/post images](#fix-inline-comment-post-images) | Fixes comment and post images hosted on preview.redd.it showing as a raw link instead of embedding, stops embedded images/GIFs from being stretched to a square, caps their size, and gives Giphy embeds a real animated fallback instead of a static link chip when Reddit's own size metadata for them is missing. |  |
