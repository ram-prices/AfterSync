...
> **[v1.10.0](https://github.com/ram-prices/AfterSync/releases/tag/v1.10.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;21 patches total
<details open>
...
| [Expressive Settings search bar](#expressive-settings-search-bar) | Makes Sync for Reddit's settings search bar more compact, matching a Material 3 Expressive-inspired restyle. |  |
