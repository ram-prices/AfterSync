...
> **[v1.11.0](https://github.com/ram-prices/AfterSync/releases/tag/v1.11.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;21 patches total
<details open>
...
| [Expressive Settings icon containers](#expressive-settings-icon-containers) | Gives Sync for Reddit's settings-row icons a rounded, tonal container background, matching a Material 3 Expressive-inspired restyle. |  |
| [Expressive Settings row cards](#expressive-settings-row-cards) | Gives every settings row its own rounded, inset card background, matching a Material 3 Expressive-inspired restyle. |  |
